...
description: Session handoff mid-diagnosis — the SFX sub-project's code is written and reviewed, but sound effects are silent during gameplay on hardware while working in the opening; five hypotheses are refuted by evidence and a fix is in flight.
metadata:
  type: project
---
