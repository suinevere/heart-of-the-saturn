...
static void test_music_index_resolves_to_track_twenty_four(void)
{
    expect_int("MENU_MUSIC_INDEX maps to cue track 24",
               discfmt_cue_track_for_music(MENU_MUSIC_INDEX), 24);
}
...
int main(void)
{
    test_music_index_resolves_to_track_twenty_four();
